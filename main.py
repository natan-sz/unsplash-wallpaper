...
access_key = "Oa_D5xaruZeVIelvW_sYXO-jJD3mlqw8DNnXQyVwkuc"
params = {"client_id":access_key,"orientation":"landscape","order_by":"latest","per_page":PER_PAGE}

mapbox_client_id = "pk.eyJ1IjoibmF0YW4tc3oiLCJhIjoiY2tydGczaW9sM2diejJ2cnZ1OWRjZW9lZSJ9.kiT0jSHi1tZ5nFBijYb1yg"
...
class Wallpaper:
    ...
    def formatImage(self):
        ...
        mapbox_url = f"https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v11/static/{self.coords[0]},{self.coords[1]},13.0,0/500x550@2x?access_token={mapbox_client_id}pk.eyJ1IjoibmF0YW4tc3oiLCJhIjoiY2tydGczaW9sM2diejJ2cnZ1OWRjZW9lZSJ9.kiT0jSHi1tZ5nFBijYb1yg" 
